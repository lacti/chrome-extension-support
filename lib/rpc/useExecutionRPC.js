...
function useExecutionRPC(_a) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        chrome.runtime.sendMessage({
                            executionId: _executionId,
                            error: serialize_error_1.serializeError(error_1),
                        });
                        return [3, 4];
                    case 4: return [2];
                }
    ...
    function listen() {
        ...
        chrome.runtime.onMessage.addListener(function (request) { return __awaiter(_this, void 0, void 0, function () {
            var _a, executionId, result, error;
            return __generator(this, function (_b) {
                _a = request, executionId = _a.executionId, result = _a.result, error = _a.error;
                logger.debug("Listen from execution", request);
                if (executionId && executionId in promiseMap) {
                    if (error !== undefined) {
                        promiseMap[executionId].reject(serialize_error_1.deserializeError(error));
                    }
                    else {
